...
%p/h line styles
%arrows at the end 
%\tikzset{ph-line-save/.style={->,>=stealth,thin}}
%\tikzset{ph-liner-save/.style={ph-line-save,<-}}
%arrows in the middle
\tikzset{ph-line-save/.style={>=stealth,thin,postaction={on each segment={mid arrow}}}}
\tikzset{ph-liner-save/.style={>=stealth,thin,postaction={on each segment={mid rarrow}}}}
%line styles
...
\newcommand{\dTone}[3][]{\dAmp[$_{T_1}$]{#1}{1}{#2}; \draw (#2) node[below] {#3};}
\newcommand{\dTtwo}[4][]{\dAmp[$_{T_2}$]{#1}{2}{#2}; \draw (#21) node[below] {#3};\draw (#22) node[below] {#4};}
\newcommand{\dTsone}[3][]{\dAmp{#1}{1}{#2}; \draw (#2) node[below] {#3};}
\newcommand{\dTstwo}[4][]{\dAmp{#1}{2}{#2}; \draw (#21) node[below] {#3};\draw (#22) node[below] {#4};}
\newcommand{\dTdone}[3][]{\dAmpD[$_{T^{\dagger}_1}$]{#1}{1}{#2}; \draw (#2) node[above] {#3};}
\newcommand{\dTdtwo}[4][]{\dAmpD[$_{T^{\dagger}_2}$]{#1}{2}{#2}; \draw (#21) node[above] {#3};\draw (#22) node[above] {#4};}
\newcommand{\dTdsone}[3][]{\dAmpD{#1}{1}{#2}; \draw (#2) node[above] {#3};}
\newcommand{\dTdstwo}[4][]{\dAmpD{#1}{2}{#2}; \draw (#21) node[above] {#3};\draw (#22) node[above] {#4};}
\newcommand{\dTdvone}[3][]{
  \tikzset{exoper-line/.style={exvac-line-save}}
  % set perturbation (if given)
  \ifx&#1&%
...
\newcommand{\dFn}[2]{\dHone[$_{F}$]{#1}; \draw (#1) node[below] {#2};}
\newcommand{\dFsn}[2]{\dHone{#1}; \draw (#1) node[below] {#2};}
\newcommand{\dFrn}[2]{\dHoner[$_{F}$]{#1}; \draw (#1) node[below] {#2};}
\newcommand{\dFsrn}[2]{\dHoner{#1}; \draw (#1) node[below] {#2};}
\newcommand{\dWn}[4]{\dHtwo[$_{W}$]{#1}{#2}; \draw (#1) node[above] {#3};\draw (#2) node[above] {#4};}
\newcommand{\dWsn}[4]{\dHtwo{#1}{#2}; \draw (#1) node[above] {#3};\draw (#2) node[above] {#4};}
...
\newcommand{\dcurt}[3]{
  ...
  \draw[ph-line] let \p1 = (#2), \p2 = (#3)
    in \pgfextra{
        ...
        \pgfmathsetmacro{\dy}{\y2>\y1}
        \pgfmathsetmacro{\ang}{90-2*atan((\y2-\y1)/(\x2-\x1+\dx/10))}
        \pgfmathsetmacro{\angi}{-180*\dy - \ang}
        \pgfmathsetmacro{\angi}{-180*\dy - \ang + 1}
